...
function sendInvoiceEmail(info) {
  const payload = {
    ...
    invoice: {
      ...
      taxAmount: info.sgst + info.cgst,
      discount: info.discount,
      extraCharges: info.extraCharges,
      total: info.total,
    },
  };

  fetch("http://localhost:5000/api/email/send-invoice-email", {
    method: "POST",
    headers: {
            ...
            <div className="p-4">
              <Row className="mb-4">
                ...
                <Col md={4}>
                  ...
                  <div className="fw-bold mt-3">Due Date:</div>
                  <div>{this.props.info.dueDate||''}</div>
                  <div className="fw-bold mt-3">Payment Terms:</div>
                  <div>{this.props.info.paymentTerms||''}</div>
                </Col>
              </Row>
            ...
            <Row>
              <Col md={6}>
                <Button variant="primary" className="d-block w-100" onClick={GenerateInvoice}>
                  <BiPaperPlane style={{width: '15px', height: '15px', marginTop: '-3px'}} className="me-2"/>Download PDF
                </Button>
              </Col>
              <Col md={6}>
                <Button variant="outline-primary" className="d-block w-100 mt-3 mt-md-0" onClick={() => sendInvoiceEmail(this.props.info)}>
